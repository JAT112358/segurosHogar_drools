...
public class MecanismoInferencia {
	...
	public static void main(String[] args) {
		try {
			...
			vivienda1.setTarea(Tarea.INICIO);
			...
			vivienda2.setTarea(Tarea.INICIO);
			...
			vivienda3.setTarea(Tarea.INICIO);
	        ...
	        // KieServices es la factor��a para crear servicios KIE 
	        KieServices kServices = KieServices.Factory.get();
	        
	        // Se crea un contenedor para la base de conocimiento a partir del KieServices
	        KieContainer kContainer = kServices.getKieClasspathContainer();
	        
	        // Se crea una sesi��n KIE en el contenedor a partir del fichero de configuraci��n  
